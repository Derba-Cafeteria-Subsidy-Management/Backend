...
import { guestTransactionRouter } from './features/guest-transaction/router/guest-transaction.router.js';
...
import { employeeGroupRouter } from './features/employee-group/router/employee-group.router.js';
...
app.use('/api/guest-transactions', guestTransactionRouter);
app.use('/api/sync', syncRouter);
app.use('/api/corrections', correctionRouter);
app.use('/api/subsidy', subsidyRouter);
app.use('/api/menus', menuRouter);
app.use('/api/employees', employeeRouter);
app.use('/api/employee-groups', employeeGroupRouter);
